...
module.exports = {
    ...
    async execute(interaction) {
        ...
        switch(socionicType){
            ...
            case "sei":
                if(subtype == "si") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "fe") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "ese":
                if(subtype == "fe") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "si") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "sle":
                if(subtype == "se") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "ti") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "iei":
                if(subtype == "ni") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "fe") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "eie":
                if(subtype == "fe") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "ni") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "lsi":
                if(subtype == "ti") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "se") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "see":
                if(subtype == "se") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "fi") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "ili":
                if(subtype == "ni") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "te") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "lie":
                if(subtype == "te") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "ni") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "esi":
                if(subtype == "fi") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "se") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
            ...
            case "iee":
                if(subtype == "ne") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ti.txt")[0].content)],})
                else if(subtype == "fi") return interaction.reply({embeds: [EmbedBuilder.from(embed).setTitle('1w9 (The Idealist)').setDescription(socionics.filter(element => element.name == "ILE-Ne.txt")[0].content)],})
